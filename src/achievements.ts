...
export const ACHIEVEMENTS: AchievementDef[] = [
  ...
  // RARE: Studio Centenarian — produce 100 lifetime films
  {
    ...
    emoji: '🏛️',
    category: 'milestone',
    description: 'Your studio has produced 100 films — a century of cinema',
    hint: 'Keep making movies. Lots of them.',
    rarity: 'rare',
    starPowerReward: { amount: 25, label: '+25 Star Power' },
    check: (_s, u) => u.careerStats.totalFilms >= 100,
    progress: (_s, u) => ({ current: Math.min(u.careerStats.totalFilms, 100), target: 100 }),
  ...
  // EPIC: Triple Crown — win with 3 different archetypes
  {
    ...
    emoji: '👑',
    category: 'skill',
    description: 'Win runs with 3 different studio archetypes — true versatility',
    hint: 'Try every studio style',
    rarity: 'epic',
    starPowerReward: { amount: 40, label: '+40 Star Power' },
    check: (_s, u) => {
  ...
  // RARE: Chemistry Master — trigger 25 chemistry bonuses lifetime
  {
    ...
    emoji: '💕',
    category: 'discovery',
    description: 'Trigger 25 chemistry bonuses across all runs — the ultimate matchmaker',
    hint: 'Pair talent wisely',
    rarity: 'rare',
    starPowerReward: { amount: 20, label: '+20 Star Power' },
  ...
  // EPIC: Underpromise, Overdeliver — exceed box office target by 200%+ on any film
  {
    ...
    emoji: '📈',
    category: 'skill',
    description: 'Exceed a box office target by 200%+ — the analysts are speechless',
  ...
  // RARE: Bankroll — finish a run with $200M+ in the bank
  {
    ...
    emoji: '🤑',
    category: 'fun',
    description: 'Finish a winning run with $200M+ in the bank — money to burn',
    hint: 'End rich, very rich',
    rarity: 'rare',
    starPowerReward: { amount: 20, label: '+20 Star Power' },
  ...
  // EPIC: Five-Star Filmography — have 5 films quality 70+ in one run
  {
    ...
    emoji: '⭐',
    category: 'skill',
    description: 'Every film in a 5-season run hits quality 70+ — consistent excellence',
    hint: 'Quality across the board',
    rarity: 'epic',
    starPowerReward: { amount: 35, label: '+35 Star Power' },
  ...
  // RARE: Seasonal Veteran — complete 20 daily challenges
  {
    ...
    emoji: '📅',
    category: 'discovery',
    description: 'Complete 20 daily challenges — a creature of habit',
